...
export const DescriptionAuthGroup: React.FC<IGroupProps> = ({
  ...
  return (
    <div className="flex flex-col gap-20  items-center w-2/3 ">
      <TextGenerateEffect
        words={
      ...
      <div
        ...
        onClick={isGroupTrue}
      >
        <AnimatedShinyText className=" text-xl flex flex-row-reverse items-center justify-center gap-3  px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
          <button>
            {" "}
