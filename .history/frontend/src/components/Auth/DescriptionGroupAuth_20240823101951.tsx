  ...
  return (
    <div className="flex flex-col gap-12   relative bottom-5 items-center w-2/3 ">
      <TextGenerateEffect
        ...
        delay={0.3}
        className="text-[#ffffff60] text-4xl max-lg:text-2xl max-sm:text-lg max-[400px]:text-base text-center  tracking-wider"
      />
      <div
        className={cn(
        ...
        onClick={isGroupTrue}
      >
        <AnimatedShinyText className=" text-xl max-lg:text-lg max-sm:text-md   px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
          <button
