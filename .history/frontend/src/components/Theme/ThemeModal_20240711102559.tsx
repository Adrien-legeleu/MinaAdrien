      ...
      <Modal>
        ...
        <ModalBody>
          ...
          <ModalFooter className="gap-4 ">
            <button className="px-2 pb-2-1 bg-gray-200 text-black dark:bg-black dark:border-black dark:text-white border border-gray-300 rounded-md text-sm w-28">
              Cancel
            </button>
            <button className="bg-black text-white dark:bg-white dark:text-black text-sm px-2 pby-1 rounded-md border border-black w-28">
              Créer !
            </button>
          </ModalFooter>
        </ModalBody>
