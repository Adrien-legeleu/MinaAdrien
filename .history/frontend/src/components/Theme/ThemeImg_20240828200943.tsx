      ...
      {theme?.images.map((img: any) => {
        if (img._id === imgId) {
          return (
            <div
              key={img._id}
              className={`z-40 px-16 max-md:px-5 max-sm:px-3 fixed relative top-0 left-0 py-4 dark:bg-black bg-white  dark:bg-dot-white/[0.2] bg-dot-black/[0.5]   w-screen h-screen flex items-center justify-center ${
                isThemeImgModalOpen
            ...
            >
              ...
              <img
                src={img.url}
                alt="img theme"
                className="z-10 w-full h-auto  object-contain rounded-3xl "
              />
