          ...
          return (
            ...
            >
              ...
              <img
                src={img.url}
                alt="img theme"
                className="rounded-3xl block max-h-[90%] max-w-[80%] z-10 absolute top-1/2 left-1/2 shadow-2xl shadow-black/30 -translate-x-1/2 -translate-y-1/2 object-contain"
              />
