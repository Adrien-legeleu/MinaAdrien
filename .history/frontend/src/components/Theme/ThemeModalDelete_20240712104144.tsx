...
export const ThemeModalDelete: React.FC<IModalDeleteProps> = ({
  ...
  return (
    <div>
      <div
        className={`absolute top-12 right-2 cursor-pointer px-5  py-1 w-16  h-8 rounded-full bg-white  flex items-center text-black justify-center border-[1px] border-black/10 ${
