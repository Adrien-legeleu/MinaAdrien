  ...
  return (
    <HeroHighlight>
      ...
      <div className="grid-cols-3 gap-8 grid pt-32 px-8">
        <div className="bg-white/60 flex items-center justify-center flex-col overflow-hidden py-5 rounded-3xl gap-5">
          <h1 className="text-2xl tracking-wider">Titre</h1>
          ...
          <div className="px-8 space-y-3 ">
            <p className="text-center text-3xl">Du 23 juillet 2017</p>
            <p className="text-center text-3xl">Au 16 mars 2023</p>
          </div>
          <div
            className={cn(
