  ...
  return (
    ...
    >
      ...
      <div className="flex gap-8 items-center justify-center">
        ...
        >
          <AnimatedShinyText className="text-xl max-md:text-3xl max-sm:text-xl px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
            <button
