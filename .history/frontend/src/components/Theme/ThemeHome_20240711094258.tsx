  ...
  return (
    <HeroHighlight>
      ...
      <div className="grid-cols-3 gap-8 grid pt-32 px-8">
        <div className="bg-white/60 flex items-center justify-center flex-col overflow-hidden py-5 rounded-3xl gap-8 border-[1px] border-black/10 shadow-2xl shadow-black/01 ">
