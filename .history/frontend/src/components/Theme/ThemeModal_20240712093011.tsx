        ...
        <ModalBody>
          <form onSubmit={submitTheme}>
            ...
            <ModalFooter className="gap-4 ">
              <p className="px-2 py-1 text-center bg-gray-200 text-black dark:bg-black dark:border-black dark:text-white border border-gray-300 rounded-md text-sm w-28">
                Cancel
              </p>
              <button
                type="submit"
