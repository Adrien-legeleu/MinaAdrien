...
export const Params: React.FC<IParamsProps> = ({ closeParams, isParams }) => {
  ...
  const update = (desc: any) => {
    console.log(desc);
    console.log("ezez");
    setDescId(desc.id); // Assurez-vous que chaque description a un identifiant unique
                ...
                <div className="flex items-center justify-end pt-5">
                  {isUpdateOpen && descId === desc.id ? (
                    ...
                    <div className="flex items-center justify-center gap-8">
                      ...
                      <div className="h-7 w-7 text-black/80 hover:scale-105 ease-in-out duration-300 cursor-pointer">
                        <IconDelete />
                      </div>
                    </div>
                  )}
