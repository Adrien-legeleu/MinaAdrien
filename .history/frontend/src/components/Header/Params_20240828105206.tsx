...
export const Params: React.FC<IParamsProps> = ({ closeParams, isParams }) => {
  ...
  return (
    ...
    >
      ...
      <ul className="my-20 flex max-lg:fixed max-lg:flex-row max-lg:shadow-2xl max-lg:shadow-black/40 max-lg:px-7 max-lg:border-none max-[820px]:w-[90%] max-lg:bg-gray-50 max-lg:py-5 max-lg:-bottom-10 max-lg:rounded-3xl max-lg:items-center max-lg:z-50 max-[1000px]:w-4/5 max-[1000px]:justify-between max-md:bg-white max-md:left-full max-md:-translate-x-full max-md:px-0 max-md:py-0 max-md:pr-5 max-md:shadow-none max-md:max-w-none max-lg:w-2/3 max-lg:left-1/2 max-lg:-translate-x-1/2 items-start justify-center gap-10 flex-col border-r-2 border-black/30">
        <li
