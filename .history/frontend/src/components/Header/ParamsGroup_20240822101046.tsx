  ...
  return (
    <div className=" font-montserrat space-y-12 pt-12 ">
      <div className="flex items-center justify-center flex-col gap-8">
        ...
        <div
          className={cn(
            "group inline-block relative mx-auto max-w-fit flex-row items-center justify-center rounded-2xl bg-white/55 px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#8fdfff1f] backdrop-blur-sm transition-shadow duration-500 ease-out dark:bg-black/40"
          )}
        >
          <span
            className={cn(
              `relative text-5xl bg-gradient-to-r from-[#ffaa40] via-[#9c40ff] to-[#ffaa40] bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient-text`
            )}
          >
            {group?.groupName}
          </span>
