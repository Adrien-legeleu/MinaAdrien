...
export const Params: React.FC<IParamsProps> = ({ closeParams, isParams }) => {
  ...
  return (
    <div
      className={`grid grid-cols-40/60 fixed relative w-full h-screen bg-white px-32 max-xl:px-16 max-xl:grid-cols-20/80 max-lg:flex max-lg:px-32 top-0 left-0 z-50 ${
    ...
    >
      ...
      <div className="fixed bottom-5 right-5 hidden max-md:visible">
        <Modal>
          <Link href="/" onClick={onLogout}>
            <ModalTrigger className="bg-black dark:bg-white dark:text-black text-white  flex justify-center group/modal-btn">
              <span className="group-hover/modal-btn:translate-x-40 text-center transition duration-500">
