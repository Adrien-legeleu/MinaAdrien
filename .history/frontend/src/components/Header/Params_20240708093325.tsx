...
export const Params: React.FC<IParamsProps> = ({ closeParams, isParams }) => {
  ...
  return (
    <div className="grid grid-cols-40/60 fixed w-full h-screen bg-gray-100 py-32 px-32 top-0 left-0 z-50">
      <ul>
        <li>Votre Groupe</li>
      ...
      <div>
        <h2 className="text-4xl tracking-wider">Vos descriptions</h2>
