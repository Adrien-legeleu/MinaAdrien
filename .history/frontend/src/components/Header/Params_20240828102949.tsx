...
export const Params: React.FC<IParamsProps> = ({ closeParams, isParams }) => {
  ...
  return (
    ...
    >
      ...
      <ul className="my-20 flex max-lg:fixed max-lg:flex-row max-lg:px-4 max-lg:border-none max-lg:bg-gray-300 max-lg:rounded-3xl items-start justify-center gap-10 flex-col border-r-2 border-black/30">
        <li
