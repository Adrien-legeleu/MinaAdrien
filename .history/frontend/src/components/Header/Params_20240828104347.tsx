...
export const Params: React.FC<IParamsProps> = ({ closeParams, isParams }) => {
  ...
  return (
    <div
      className={`grid grid-cols-40/60 fixed w-full h-screen bg-white px-32 max-xl:px-16 max-xl:grid-cols-20/80 max-lg:flex max-lg:px-32 top-0 left-0 z-50 ${
    ...
    >
      ...
      <ul className="my-20 flex max-lg:fixed max-lg:flex-row max-lg:shadow-2xl max-lg:shadow-black/40 max-lg:px-7 max-lg:border-none max-lg:bg-gray-50 max-lg:py-5 max-lg:-bottom-10 max-lg:rounded-3xl max-lg:items-center max-lg:z-50 max-[1000px]:w-4/5 max-md:bg-none max-md:right-5 max-md:w-auto max-lg:w-2/3 max-lg:left-1/2 max-lg:-translate-x-1/2 items-start justify-center gap-10 flex-col border-r-2 border-black/30">
        <li
          onClick={() => scrollToSection(1, groupRef)}
          className={`pb-2 text-xl max-lg:text-base max-lg:tracking-normal tracking-wider cursor-pointer ${
            selectedIndex === 1
      ...
      <div
        className="space-y-20 py-20 px-12 overflow-y-scroll max-lg:h-full  h-screen "
