...
export const Params: React.FC<IParamsProps> = ({ closeParams, isParams }) => {
  ...
  return (
    <div
      className={`grid grid-cols-40/60 fixed  w-full h-screen bg-white px-32 max-xl:px-16 max-md:px-5 max-[600px]:px-9 max-xl:grid-cols-20/80 max-lg:flex max-lg:px-32 top-0 left-0 z-50 ${
