        ...
        <form onSubmit={submit}>
          ...
          <div className="flex items-center justify-center">
            {isAddOpen ? (
              <div
                className={cn(
                  "group mt-4 rounded-full p-1 border border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800"
                )}
              >
