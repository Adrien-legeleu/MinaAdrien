    ...
    <div className="h-full relative w-full ">
      ...
      <div className="absolute top-1/2 right-10 w-screen">
        ...
        <form
          ...
          }  duration-300 ease-in-out absolute shadow-2xl shadow-black/30 -top-16 right-20 max-sm:right-0 max-sm:top-16 py-8 rounded-2xl w-[500px] max-md:w-2/3 max-sm:w-4/5 z-10 flex items-center justify-center flex-col backdrop-blur-sm border-[1px] border-black/30 gap-8`}
        >
