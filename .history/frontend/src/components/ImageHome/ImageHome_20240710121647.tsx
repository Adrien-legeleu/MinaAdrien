    ...
    <div className="h-full relative w-full">
      ...
      <div className="absolute top-1/2 right-10">
        ...
        <form
          ...
          }  duration-300 ease-in-out absolute -top-16 right-20 py-8 px-4 rounded-2xl w-96 flex items-center justify-center flex-col bg-white gap-8`}
        >
        ...
        <div
          className={`${
            isCreateOpen ? "visible bg-black" : "hidden"
