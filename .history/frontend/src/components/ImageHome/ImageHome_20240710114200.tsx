  ...
  return (
    <div className="h-full relative w-full">
      ...
      <div className="absolute top-1/2 right-10">
        <div className="p-3 flex items-center justify-center shadow-xl shadow-black/60 bg-gray-50 rounded-full h-16 w-16">
          <IconPlusGroup />
        </div>
        <form
          onSubmit={submitImage}
          className={`${
            isCreateOpen ? "visible opacity-100" : "invisible hidden opacity-0"
