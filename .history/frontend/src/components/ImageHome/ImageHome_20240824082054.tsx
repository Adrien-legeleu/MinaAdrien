    ...
    <div className="h-full relative w-full ">
      ...
      <div className="absolute top-1/2 right-10">
        ...
        <form
          ...
          }  duration-300 ease-in-out absolute shadow-2xl shadow-black/30 -top-16 right-20 py-8 rounded-2xl w-[500px] max-md:w-2/3 z-10 flex items-center justify-center flex-col backdrop-blur-sm border-[1px] border-black/30 gap-8`}
        >
