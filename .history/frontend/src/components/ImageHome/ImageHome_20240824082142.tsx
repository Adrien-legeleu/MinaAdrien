    ...
    <div className="h-full relative w-full ">
      ...
      <div className="absolute top-1/2 right-10">
        ...
        <form
          ...
          }  duration-300 ease-in-out absolute shadow-2xl shadow-black/30 -top-16 right-20 py-8 rounded-2xl w-[500px] max-md:w-2/3 max-sm:w-4/5 z-10 flex items-center justify-center flex-col backdrop-blur-sm border-[1px] border-black/30 gap-8`}
        >
          ...
          >
            <AnimatedShinyText className=" text-xl mx-sm:text-base  px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
              <button
