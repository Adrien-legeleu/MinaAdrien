  ...
  return (
    <div className="h-full relative w-full">
      {images[0] ? (
        ...
        <p
          className={cn(
            `text-4xl w-1/2 py-48 mx-auto tracking-widest text-center leading-loose font-semibold  animate-gradient bg-gradient-to-r from-[#ffaa40] via-[#9c40ff] to-[#ffaa40] bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent`
          )}
        >
