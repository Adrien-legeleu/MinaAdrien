        ...
        <div className="grid gap-10">
          {firstPart.map((el, idx) => (
            ...
            >
              <img
                src={el.url}
                className=" w-full h-auto  rounded-3xl shadow-xl shadow-black/30 gap-10 !m-0 !p-0"
                height="400"
                width="400"
                alt={el.url}
              />
        ...
        <div className="grid gap-10">
          {thirdPart.map((el, idx) => (
            ...
            >
              <img
                src={el.url}
                className="h-auto w-full object-cover rounded-3xl shadow-xl shadow-black/30 gap-10 !m-0 !p-0"
                height="400"
                width="400"
                alt="thumbnail"
              />
