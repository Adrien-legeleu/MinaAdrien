      ...
      <HeaderParams />
      {
        <div className="w-1/2 mx-auto">
          {description[0] ? (
            ...
            <p
              className={cn(
                `text-4xl tracking-wider text-center flex items-center justify-center leading-loose font-semibold inline animate-gradient bg-gradient-to-r from-[#ffaa40] via-[#9c40ff] to-[#ffaa40] bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent`
              )}
            >
