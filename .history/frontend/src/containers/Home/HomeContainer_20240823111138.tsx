...
export const HomeContainer: React.FC<GroupContainerDetailsProps> = ({
  ...
  return (
    <div className="py-8 ">
      <div className="absolute top-8 left-8  h-12 w-16 max-sm:h-6 max-sm:w-10 max-sm:left-4">
        <BackGroup />
      </div>
      <HeaderParams
        isParams={isParams}
...

      {
        <div className="w-1/2 mx-auto pb-48">
          {description[0] ? (
            <p className="text-3xl max-sm:text-2xl text-[#d83c3c] text-center  leading-loose tracking-widest">
