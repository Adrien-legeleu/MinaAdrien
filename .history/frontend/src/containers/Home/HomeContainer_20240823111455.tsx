...
export const HomeContainer: React.FC<GroupContainerDetailsProps> = ({
  ...
  return (
    <div className="py-8 ">
      ...
      {
        <div className="w-1/2 mx-auto pb-48 max-sm:pt-16">
          {description[0] ? (
            <p className="text-3xl max-sm:text-2xl max-[400px]:text-lg  text-[#d83c3c] text-center  leading-loose tracking-widest">
