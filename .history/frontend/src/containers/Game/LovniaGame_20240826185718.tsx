      ...
      {!gameOn ? (
        ...
        <div className="space-y-10">
          ...
          <div className="columns-2 gap-20 px-20 max-md:gap-10 max-md:px-10 max-sm:gap-5 max-sm:px-5 ">
            <div className="w-full  h-auto my-auto flex justify-center items-center relative ">
              <img
                src={imagesGame[indexes[0]]}
                alt={"lovnia photo" + indexes[0]}
                className="h-hauto  cursor-pointer my-auto w-full rounded-2xl"
            ...
            <div className="w-full  h-auto my-auto flex justify-center items-center relative ">
              <img
                ...
                className="h-auto w-full my-auto cursor-pointer rounded-2xl"
