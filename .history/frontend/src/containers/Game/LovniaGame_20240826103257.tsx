    ...
    <div className="mt-32">
      ...
      {!gameOn ? (
        isFinish ? (
          <div className="flex items-center justify-center flex-col ">
            <TextGenerateEffect
              ...
              delay={0.3}
              className="text-[#d42121c9] text-4xl max-lg:text-2xl max-sm:text-lg max-[390px]:text-base text-center tracking-wider"
            />
            <img
              src={imagesGame[0]}
              className="w-2/3 object-contain rounded-3xl "
          ...
          <div className=" flex items-center justify-center flex-col gap-16">
            <TextGenerateEffect
              ...
              delay={0.3}
              className="text-[#d42121c4] text-4xl max-lg:text-2xl max-sm:text-lg max-[390px]:text-base text-center tracking-wider"
            />
            <button
              onClick={playGame}
        ...
        <div className="space-y-10">
          <button
            className="bg-black rounded-xl ml-10 px-6 py-2 text-xl cursor-pointer hover:scale-105 duration-300 ease-in-out text-white"
            onClick={restartGame}
          >
            retour
          </button>
          <div className="grid grid-cols-2 bg-red-700 gap-16 items-center justify-center">
            <div className="w-2/3 bg-blue-300 h-full flex justify-center items-center relative ">
              <img
            ...
            <div className="w-2/3 bg-blue-300 h-full mx-auto flex justify-center items-center relative ">
              <img
                src={imagesGame[indexes[1]]}
                alt={"lovnia photo" + indexes[1]}
                className="h-full w-full mx-auto cursor-pointer object-contain rounded-3xl"
