      ...
      {!gameOn ? (
        isFinish ? (
          <div className="flex items-center justify-center flex-col ">
            ...
            />
            <img src={imagesGame} alt="photo lovnia coup de coeur" />
          </div>
        ) : (
        ...
        <div className="space-y-10">
          <button
            className="bg-black rounded-xl mr-10 px-6 py-2 text-xl cursor-pointer hover:scale-105 duration-300 ease-in-out text-white"
            onClick={restartGame}
          >
            retour
          </button>
