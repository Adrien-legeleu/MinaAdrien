            ...
            <div className="grid grid-cols-4 gap-12 ">
              {user?.groups.map((group: any) => (
                <Link
                  ...
                  onClick={() => localStorage.setItem("groupId", group.groupId)}
                >
                  <div
                  ...
                  >
                    ...
                    {isModalDeleteOpen && groupId === group.groupId ? (
                      <div className="absolute top-0 h-7 w-7 -right-6 px-4 py-2 bg-white/80 rounded-full flex items-center justify-center">
                        <IconDelete />
                      </div>
                    ) : (
                      <div></div>
