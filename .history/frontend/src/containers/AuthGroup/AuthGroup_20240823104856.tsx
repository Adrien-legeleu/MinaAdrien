    ...
    <BackgroundGradientAnimation>
      <div className="absolute inset-0 z-50 flex gap-16 max-md:gap-20  flex-col pt-10 items-center justify-center font-montserrat">
        ...
        {!isGroup ? (
          ...
          <div
            className="w-3/4 mx-auto pt-10 px-2 relative max-md:w-2/3 max-[600px]:w-4/5 max-[460px]:w-5/6 max-[400px]:w-[95%]"
            style={{ scrollbarWidth: "none" }}
          >
            <div className="grid grid-cols-4 max-lg:grid-cols-3 max-md:grid-cols-2 gap-12 max-md:gap-9 ">
