...
export const AuthGroup = () => {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] overflow-y-hidden">
      <Spotlight
      ...
      {!isGroup ? (
        ...
        <div className="text-white">
          e,jeizjdizjdizjdijzidjidjzidjizjdizjdizjd
        </div>
      )}
    </div>
  );
