        ...
        {!isGroup ? (
          ...
          >
            <div className="grid grid-cols-4 gap-12 ">
              ...
              <div
                className="rounded-3xl py-10 px-10 border-[1px] bg-white/80 text-black/70 cursor-pointer hover-bg-white/70 ease-in-out duration-300 flex items-center justify-center"
