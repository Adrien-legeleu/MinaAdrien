...
export const AuthGroup = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col gap-12  items-center justify-center bg-black/[0.96] overflow-y-hidden">
      <Spotlight
      ...
      <h1>
        <TextGenerateEffect
          words={"LOVNA"}
          className="text-[#ffffffc2] text-4xl text-center  tracking-wider"
        />
      </h1>
      {!isGroup ? (
