          ...
          >
            <div className="grid grid-cols-4 gap-12 ">
              {user?.groups.map((group: any) => (
                <div className="bg-white/90 relative py-5 px-2 flex flex-col items-center jusitfy-between rounded-3xl  gap-6  cursor-pointer hover:bg-white/80 hover:scale-105 duration-300 ease-in-out">
                  <Link
                    ...
                    >
                      ...
                      {isModalDeleteOpen && groupId === group.groupId ? (
                        <div
                          ...
                          className="absolute top-0 h-7 w-7 -right-6 px-4 py-2 bg-white/80 rounded-full flex items-center justify-center"
                        >
                          <IconDelete />
                        </div>
                      ) : (
