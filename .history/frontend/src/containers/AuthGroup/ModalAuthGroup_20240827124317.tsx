...
export const ModalAuthGroup: React.FC<IModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`bg-white/95  rounded-3xl shadow-xl max-md:flex-col  shadow-slate-600 z-20 flex items-center justify-center py-16 px-16 gap-16 ${
          isModalOpen
      ...
      >
        <div
          className=" w-48 h-48 flex flex-col max-sm:w-32 max-sm:h-32 cursor-pointer text-black/80 items-center justify-center gap-3"
        ...
        <div
          ...
          className="h-48 w-48 flex flex-col max-sm:w-32 max-sm:h-32  text-black/80 cursor-pointer items-center justify-center gap-3"
        >
          <IconJoinGroup />
          <h3 className="text-gray-400 uppercase text-center cursor-pointer">
            rejoindre{" "}
