...
export const AuthGroup = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col gap-20  items-center justify-center bg-black/[0.96] overflow-y-hidden">
      <Spotlight
        className="-top-40 left-0 md:left-60 md:-top-20"
        fill="white"
      />
      <AnimatedShinyText className=" text-4xl transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
        <h1>LOVNA</h1>
      </AnimatedShinyText>
      {!isGroup ? (
