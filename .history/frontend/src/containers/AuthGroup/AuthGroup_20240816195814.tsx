        ...
        {!isGroup ? (
          ...
          >
            <div className="grid grid-cols-4 gap-12 ">
              ...
              <div
                className="rounded-3xl py-10 px-10 border-[1px] bg-white/90 text-black/75 cursor-pointer hover:scale-95 hover:bg-white/70 ease-in-out duration-300 flex items-center justify-center"
