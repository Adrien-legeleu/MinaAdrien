...
export const Create: React.FC<ICreateProps> = ({ isCreateFalse }) => {
  ...
  return (
    <div className=" z-50 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  bg-white/80 w-full  shadow-white shadow-2xl flex items-center justify-center">
