...
export const ModalAuthGroup: React.FC<IModalProps> = ({
  ...
  return (
    <div className={`h-screen w-full fixed top-0 left-0 z-50 flex items-center justify-center ${
          isModalOpen ? "visible" : "hidden"
        }`}
      <div
        className={`h-screen w-full  backdrop-blur-[5px] z-10 flex items-center justify-center ${
          isModalOpen ? "visible" : "hidden"
        }`}
      ></div>
