...
export const ModalAuthGroup: React.FC<IModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`h-screen w-full  backdrop-blur-[5px] z-10 absolute top-0 left-0${
          isModalOpen ? "visible" : "hidden"
        }`}
      ></div>
      <div className="absolute top-20 left-20 text-white z-20 ">fermer</div>
      <div
        className={`bg-black shadow-xl shadow-slate-600 z-20 flex items-center justify-center py-20 px-16 gap-16 ${
          isModalOpen
