  ...
  return (
    <BackgroundGradientAnimation>
      <div className="absolute inset-0 z-50 flex gap-16  flex-col pt-10 items-center justify-center font-montserrat">
        ...
        <h1 className="text-5xl max-lg:text-4xl max-md:text-3xl max-sm:text-2xl max-sm:text-center tracking-wider font-bold bg-clip-text text-transparent drop-shadow-2xl bg-gradient-to-b from-white/80 to-white/20">
        ...
        {!isGroup ? (
          ...
          >
            <div className="grid grid-cols-4 max-lg:grid-cols-3 max-msm:grid-cols-2 gap-12 ">
