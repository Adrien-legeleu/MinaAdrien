      ...
      <div className="absolute inset-0 z-50 flex gap-16  flex-col pt-10 items-center justify-center">
        ...
        {!isGroup ? (
          ...
          <div className="w-2/3 relative">
            <div className="h-10 w-full absolute top-0 left-0 backdrop-blur-sm bg-black z-10"></div>{" "}
            <div
              className="w-full mx-auto overflow-y-scroll rounded-t-3xl pt-10 relative"
