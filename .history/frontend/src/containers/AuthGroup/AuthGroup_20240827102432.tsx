              ...
              {allGroups ? (
                allGroups.map((group: any) => (
                  <div
                    key={group._id}
                    style={{
                      backgroundImage: `url(${group.urlProfil})`,
                    }}
                    className="space-y-3 border-black/60 border-[1px] relative py-7 px-5 rounded-3xl cursor-pointer hover:bg-white/90 hover:scale-105 duration-300 ease-in-out"
                  >
                    <div
