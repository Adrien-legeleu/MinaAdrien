  ...
  return (
    <div className="h-screen bg-black/[0.96] w-full flex items-center justify-center">
      ...
      <div className="flex flex-col gap-12">
        ...
        <div
          className={cn(
            "group rounded-full flex items-center justify-center p-1 border border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800"
          )}
        >
