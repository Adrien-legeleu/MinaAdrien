          ...
          >
            <div className="grid grid-cols-4 gap-12 ">
              {allGroups.map((group: any) => (
                <div className="bg-white/10  space-y-3 border-black/20 border-[1px] relative py-5 px-2  rounded-3xl  cursor-pointer hover:bg-white/80 hover:scale-105 duration-300 ease-in-out">
                  <div
