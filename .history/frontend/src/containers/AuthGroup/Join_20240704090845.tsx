...
import { IGroupFormsValues, IPseudoFormValues, useGroupContext } from "@/context/GroupContexts";
...
export const Join = () => {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const values = {
      userId: user?._id
      pseudo: data.get("groupname"),
      grouId: data.get("password"),
    };
    console.log(values);
    await onLogin(values as IPseudoFormValues);
  };
