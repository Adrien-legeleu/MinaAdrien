...
export const GalleryContainer = () => {
  ...
  return (
    <div className="py-8">
      ...
      {selectedImages && (
        <div className="fixed bottom-10 right-7 grid grid-cols-2 items-center justify-center gap-5 w-32 h-10">
          <div className="space-x-3">
            <button
              className="p-2 w-full h-full bg-white text-black rounded-full"
              onClick={() => deleteOneImage(selectedImages)}
            >
              <IconDelete />
            </button>
            <button className="p-2 w-full h-full bg-white text-black rounded-full">
              <IconDeleteAll />
            </button>
          </div>
