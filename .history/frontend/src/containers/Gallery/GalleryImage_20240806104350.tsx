...
export const GalleryImage: React.FC<ImageGalleryProps> = ({
  ...
  return (
    <div
      className={`fixed grid grid-cols-70/30 gap-10 inset-0 top-0 left-0 h-screen w-screen z-50 ${
        isOpenModal
    ...
    >
      <div
        ...
        onClick={modalClose}
      ></div>
      <div className="relative w-full h-full z-10 mb-12 m-10 ">
        <img
      ...
      >
        <div className="space-y-8">
          ...
          />
          <Input type="date" name="dataPhoto" defaultValue={image?.dataPhoto} />
        </div>
