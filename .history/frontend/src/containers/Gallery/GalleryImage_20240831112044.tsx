...
export const GalleryImage: React.FC<ImageGalleryProps> = ({
  ...
  return (
    <div
      className={`fixed grid grid-cols-70/30 max-lg:grid-cols-2  max-md:flex max-md:flex-col max-md:items-center max-md:justify-center gap-10 p-8 inset-0 top-0 left-0 h-screen w-screen z-50 ${
        isOpenModal
