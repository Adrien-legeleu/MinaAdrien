...
export const GalleryContainer = () => {
  ...
  return (
    <div className="py-8">
      ...
      />
      <div className="columns-4 gap-7 max-sm:gap-4 max-sm:px-4 px-7 pt-20">
        {images.map((image: IImage) => {
          ...
          return (
            <div key={image._id} className="group relative">
              ...
              <img
                className="rounded-3xl block h-auto w-full group-hover:brightness-75 duration-300 ease-in-out cursor-pointer"
                src={image.url}
