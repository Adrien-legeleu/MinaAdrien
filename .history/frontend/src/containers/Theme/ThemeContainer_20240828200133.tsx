...
export const ThemeContainer: React.FC<ThemeContainerDetailsProps> = ({
  ...
  return (
    <div className=" py-4 w-full  dark:bg-black bg-white  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex flex-col items-center justify-center">
      ...
      <div className="columns-2 max-sm:flex max-sm:flex-col max-xl:gap-6 max-lg:gap-5  px-16 max-xl:px-6  max-lg:px-5 max-md:gap-4 max-md:px-4 max-sm:px-5  items-center justify-center">
        {theme?.images.map((img: any) => {
          return (
            <div className="h-auto w-full mt-10">
              <div className="bg-gray-50 relative flex flex-col gap-6 /[0.2] border-black/[0.1] h-auto  rounded-xl p-6 border  ">
