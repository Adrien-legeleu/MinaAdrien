              ...
              <CardBody className="bg-gray-50 relative group/card flex flex-col gap-6 dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
                ...
                <div className="flex justify-between items-center ">
                  <CardItem
                    translateZ={100}
                    translateX={40}
                    className="px-4 py-2 rounded-x cursor-pointerl text-black/80  tracking-wider font-semibold"
                  >
                  ...
                  >
                    <lord-icon
                      ...
                      className="w-12 h-12 hover:scale-110 duration-300 ease-in-out cursor-pointer"
                    ></lord-icon>
                  </CardItem>
                </div>
              </CardBody>
