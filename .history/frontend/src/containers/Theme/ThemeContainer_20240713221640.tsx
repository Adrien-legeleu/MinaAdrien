                  ...
                  {isThemeUpdateOpen && img._id === imgId ? (
                    ...
                    <>
                      ...
                      >
                        ...
                        <div
                          className={`absolute -top-28 z-20 right-0 flex items-end justify-center flex-col gap-2 ${
                        ...
                        >
                          <p
                            ...
                            className="flex cursor-pointer gap-4 items-center justify-center px-4 py-2 rounded-full text-black/80 bg-white/95 border-[1px] border-black/20"
                          >
                            supprimer{" "}
