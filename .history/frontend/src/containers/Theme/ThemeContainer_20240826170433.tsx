...
export const ThemeContainer: React.FC<ThemeContainerDetailsProps> = ({
  ...
  return (
    <div className=" py-4 w-full  dark:bg-black bg-white  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex flex-col items-center justify-center">
      ...
      <div className="grid-cols-2 grid max-md:grid-cols-1 max-xl:gap-10 max-lg:gap-5 gap-20 px-4 items-center justify-center">
        ...
        {createThemeImgOpen ? (
          ...
          <div className="items-center z-20 py-10 justify-center flex">
            <button
