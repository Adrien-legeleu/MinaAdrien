...
export const ThemeContainer: React.FC<ThemeContainerDetailsProps> = ({
  ...
  return (
    <div className="w-full dark:bg-black bg-white relative flex items-center justify-center">
      {/* Radial gradient for the container to give a faded look */}
      <div className="absolute inset-0 pointer-events-none flex items-center justify-center [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] dark:bg-black bg-white"></div>
      ...
      <div className="pt-12 flex items-center justify-center flex-col gap-5 relative z-20">
        <h1
          className={cn(
          ...
          style={{ zIndex: 50 }} // Ajout du z-index pour placer le titre au-dessus
        >
          {theme?.title}
        </h1>
      ...
      <div className="grid-cols-2 grid relative z-10">
        {theme?.images.map((img: IImage) => {
          return (
            <div key={img._id} className="inter-var">
