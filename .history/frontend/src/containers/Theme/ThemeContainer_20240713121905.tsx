              ...
              <CardContainer className="inter-var">
                <CardBody className="bg-gray-50 relative group/card flex flex-col gap-6 dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
                  {isThemeUpdateOpen ? (
                    ...
                    <>
                      <div className="absolute top-5 z-20 right-0 text-black/80 h-10 w-10 focus:scale-125">
                        <IconEllipsis />
                        <div className="absolute top-8 z-20 right-0 flex items-start justify-center flex-col gap-4">
                          <p className="flex gap-4 items-center justify-center px-4 py-2 rounded-full text-black/80 bg-white/80 border-[1px] border-black/20">
                            supprimer{" "}
