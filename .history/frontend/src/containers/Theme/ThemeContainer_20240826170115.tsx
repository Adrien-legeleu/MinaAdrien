...
export const ThemeContainer: React.FC<ThemeContainerDetailsProps> = ({
  ...
  return (
    <div className=" py-4 w-full  dark:bg-black bg-white  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex flex-col items-center justify-center">
      ...
      <div className="grid-cols-2 grid max-md:grid-cols-1 max-xl:gap-10 max-lg:gap-5 gap-20 px-4">
        {theme?.images.map((img: any) => {
          return (
            <>
              <div className="bg-gray-50 relativeflex flex-col gap-6 dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1]  rounded-xl p-6 border  ">
