      ...
      <div className="absolute inset-0 z-50 flex gap-16  flex-col items-center justify-end pb-12 text-white">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-center">
            <div
              className={cn(
                "group rounded-full py-1 pw-3 border border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800"
              )}
            >
