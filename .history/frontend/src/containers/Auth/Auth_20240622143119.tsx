      ...
      <div className="absolute inset-0 z-50 flex gap-16  flex-col items-center justify-center text-white">
        ...
        <div className="space-y-12">
          ...
          <div className="flex items-center justify-center">
            ...
            >
              <AnimatedShinyText className="inline flex flex-row-reverse text-xl items-center justify-center gap-4 px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
                <span>
                  {" "}
