      ...
      <div className="absolute inset-0 z-50 flex gap-16  flex-col items-center justify-end pb-12 text-white">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-center">
            ...
            >
              <AnimatedShinyText className="inline-flex text-xl gap-5 items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
                <span>✨ Login</span>
              </AnimatedShinyText>
            </div>
          </div>
