          ...
          <div className="space-y-4">
            <div className="relative w-full min-w-[200px]">
              <input
                ...
                className="border-none rounded-3xl py-4 px-5 bg-gradient-to-b from-white/80 to-white/2 text-gray-500 outline-none"
              />
            </div>
            <div className="relative  w-full min-w-[200px]">
              <div className="relative h-11 w-full min-w-[200px]">
                <input
                  ...
                  className="border-none rounded-3xl py-4 px-5 bg-red-600 bg-gradient-to-b from-white/80 to-white/2 text-gray-500 outline-none"
                />
              </div>
            </div>
          </div>
