  ...
  return (
    <BackgroundGradientAnimation>
      <div className="absolute inset-0 z-50 flex gap-16  flex-col items-center justify-center text-white">
          ...
          <div className="space-y-4">
            <div className="relative h-11 w-full min-w-[200px]">
              <input
                ...
                className="border-none rounded-full py-4 px-5  text-xl bg-white text-gray-500 outline-none"
              />
            </div>
            <div className="relative h-11 w-full min-w-[200px]">
              <input
        ...
        <div
          className={cn(
            " absolute right-5 bottom-5 w-full group rounded-full p-1 border border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800"
          )}
        >
          <AnimatedShinyText className="  inline-flex text-sm items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
            <span> Ps encore de compte ? Créez en un dès maintenant !</span>
          </AnimatedShinyText>
        </div>
      </div>
    </BackgroundGradientAnimation>
